...
過去のレース結果（2024年1月〜2025年10月、48,700レース）から抽出した全選手データ：

| データ項目 | カバー率 | 内訳 |
|-----------|---------|------|
| **選手名・府県** | 100% (2,499名) | 全選手 |
| **階級** | 91% (2,281名) | S1: 617名 / A1: 1,664名 |
| **脚質** | 99.5% (2,487名) | 逃/追/両 |

**選手名を1文字入力するだけで、候補がドロップダウン表示され、階級・脚質・府県が自動入力されます！**
