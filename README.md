...
**完全無料！** クラウドにデプロイしてiPhoneだけで使えます。

👉 **詳しい手順は [DEPLOY.md](DEPLOY.md) を参照**

**簡単な流れ:**
1. GitHub + Render.com（無料）にデプロイ
...
- **[DEPLOY.md](DEPLOY.md)** - 📱 **iPhone単体で使う方法（クラウドデプロイ）**
- [README_APP.md](README_APP.md) - アプリの詳細仕様とAPI仕様
- [QUICKSTART_IPHONE.md](QUICKSTART_IPHONE.md) - ローカル環境でiPhoneから使う方法

## 🔒 セキュリティとプライバシー

- **クラウドデプロイの場合**: HTTPS通信で暗号化、データは外部に送信されません
- **ローカル環境の場合**: ローカルネットワーク内でのみ動作
- 予測結果は参考値です
- 賭博行為を推奨するものではありません
